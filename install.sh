...
detect_device() {
    ...
    # Determine GPU driver based on actual hardware EGL property only
    # Brand-based guessing is unreliable (e.g. Samsung uses both Adreno and Mali)
...
step_metasploit() {
    ...
    echo -e "  ${GREEN}✓${NC} Run 'msfconsole' to launch Metasploit"
}
...
step_wine() {
    ...
    # Symlink wine binary (only if installation succeeded)
...
# Kill any existing sessions (SIGTERM first, then SIGKILL)
...
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo ""
startxfce4 || echo -e "\n⚠ XFCE4 exited unexpectedly. Check logs: cat ~/.xsession-errors"
LAUNCHEREOF
    ...
    case $choice in
        1)
            ...
            if [[ "$target" =~ ^[a-zA-Z0-9._/-]+$ ]]; then
                ...
                echo "  ✗ Invalid target. Only letters, digits, dots, dashes allowed."
            fi
